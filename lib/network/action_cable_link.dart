...
/// A function that returns the headers to be sent to the server
typedef GetDefaultHeaders = FutureOr<Map<String, String>> Function();
...
class ActionCableLink extends Link {
  ...
  /// A function that returns the headers to be sent to the server
  final GetDefaultHeaders? defaultHeadersAsync;
  ...
  Future<Map<String, String>> _getHeaders() async {
    ...
    if (defaultHeadersAsync != null) {
      final asyncHeaders = await defaultHeadersAsync!();
